...
definition_exists_tests = [
    ...
    (("hdn", "eng"), "gatáa.ang ñasa'áa", "for S to eat"),
    (("hdn", "eng"), "kíl is", "for S to tell C to stay in location"),
    (
        ("hdn", "eng"),
        "skyáahl'uuj",
        "for S to be lucky [said of a man or of hunting/fishing tools (but not a gun)]",
    ),
    (
        ("hdn", "eng"),
        "skyáahläsaa.ang",

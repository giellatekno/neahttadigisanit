        ...
        for line in self.fhandle:
            ...
            if tokens[0] in keywords and nb_tokens > 1:
                ...
                if re.search(r'([^\\]|^)"', line[1:-1]):
                    raise IOError(
                        ...
                        "unescaped double quote found" % (self.instance.fpath, i)
                    )
            ...
            if tokens[0] == "#:":
                ...
                if tokens[1] not in prev_keywords:
                    ...
                    raise IOError(
                        "Syntax error in po file %s (line %s): "
                        "unknown keyword %s" % (self.instance.fpath, i, tokens[1])
                    )
                ...
                raise IOError(
                    "Syntax error in po file %s (line %s)" % (self.instance.fpath, i)
                )

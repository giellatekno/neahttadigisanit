...
def add_stem2dict():
    ...
    for lexc in lexc_list:
        if not lexc == 'prop':
            lexc_cmd = 'python $GTHOME/words/dicts/scripts/add_stemtype2xml.py ' + lexc + ' $GTHOME/words/dicts/smenob/scripts/' + lexc + '_stemtypes.txt dicts/sme-nob.all.xml $HOME/all-gut/giellalt/lang-sme/src/fst/stems/' + lexc + '.lexc '
        else:
            lexc_cmd = 'python $GTHOME/words/dicts/scripts/add_stemtype2xml.py prop $GTHOME/words/dicts/smenob/scripts/' + lexc + '_stemtypes.txt dicts/sme-nob.all.xml $HOME/all-gut/giellalt/lang-sme/src/fst/stems/sme-propernouns.lexc $HOME/all-gut/giellalt/giella-shared/smi/src/fst/stems/smi-propernouns.lexc'

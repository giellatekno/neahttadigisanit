...
module.Selection = Selection = (function() {
  ...
  Selection.prototype.getMultiwordEnvironment = function(l, r) {
    var first_word, following_words, last_word, previous_words;
    if (l == null) {
      l = 1;
    }
    if (r == null) {
  ...
  Selection.prototype.getMultiwordPermutations = function(l, r) {
    ...
    mws = this.getMultiwordEnvironment(l, r);
    word_delimiter = ' ';
...
jQuery(document).ready(function($) {
  ...
  lookupSelectEvent = function(evt, string, element, range, opts, full_text) {
    var langpair, lookup_string, mws, post_data, response_func, result_elem, settings, source_lang, target_lang, uri, url, _cp, _ref;
  ...
  $.fn.selectToLookup = function(opts) {
    ...
    initializeWithSettings = function() {
      ...
      holdingOption = (function(_this) {
        return function(evt) {
          var element, full_text, range, string, within_options, _ref;
          clean(evt);
          if (evt.altKey) {
            element = evt.target;
            ...
            _ref = selectionizer.getFirstRange(), range = _ref[0], full_text = _ref[1];

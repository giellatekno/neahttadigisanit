...
// the whole app..
jQuery(document).ready(function(){rangy.init(),jQuery(document).selectToLookup({api_host:NDS_API_HOST+"/",tooltip:!0,displayOptions:!0,spinnerImg:NDS_API_HOST+"/static/img/spinner.gif"})});
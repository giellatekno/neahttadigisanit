...
def process_crk_tag(analysis_string, tag_separator='+'):
    """ Take an analysis string, and return a tuple of the lemma,
    ...
    material are not changed.
        ...
        >>> process_crk_tag("PV/asdf+PV/bbq+lemma+POS+Type+Sg1")
        ('lemma', 'PV/asdf+PV/bbq+POS+Type+Sg1')
        >>> process_crk_tag("lemma+POS+Type+Sg1")
        ('lemma', 'lemma+POS+Type+Sg1')
        >>> process_crk_tag("PV/asdf+PV/bbq+lemma")
        ('lemma', 'PV/asdf+PV/bbq+POS+Type+Sg1')

    """
    lemma = False

    tag_sep = tag_separator
    ...
    return (lemma, reformatted_tag)

def main():
    print '--'
    print process_crk_tag("PV/asdf+PV/bbq+lemma+POS+Type+Sg1")
    # ('lemma', 'PV/asdf+PV/bbq+POS+Type+Sg1')
    print process_crk_tag("lemma+POS+Type+Sg1")
    # ('lemma', 'lemma+POS+Type+Sg1')
    print process_crk_tag("PV/asdf+PV/bbq+lemma")
